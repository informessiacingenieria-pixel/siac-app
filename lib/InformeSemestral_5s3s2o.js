...
export async function generarPdfSemestral5s3s2oBlob(datos) {
  ...
  // ===================== PÁGINA 1 - OSMOSIS 1 (5 membranas) =====================
    ...
    m1Pre:  { x: 196, y: 215 }, m1Post: { x: 184, y: 271 },
    m2Pre:  { x: 322, y: 217 }, m2Post: { x: 305, y: 271 },
    m3Pre:  { x: 195, y: 323 }, m3Post: { x: 184, y: 379 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 210, y: 143 }, m1Post: { x: 195, y: 212 },
    m2Pre:  { x: 318, y: 144 }, m2Post: { x: 314, y: 212 },
    m3Pre:  { x: 428, y: 143 }, m3Post: { x: 434, y: 212 },
    entrada:{ x: 538, y: 180 }, salida: { x: 652, y: 165 },
