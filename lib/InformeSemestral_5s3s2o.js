...
export async function generarPdfSemestral5s3s2oBlob(datos) {
  ...
  // ===================== PÁGINA 1 - OSMOSIS 1 (5 membranas) =====================
    ...
    m1Pre:  { x: 180, y: 215 }, m1Post: { x: 180, y: 272 },
    m2Pre:  { x: 315, y: 215 }, m2Post: { x: 302, y: 272 },
    m3Pre:  { x: 170, y: 323 }, m3Post: { x: 170, y: 380 },
    m4Pre:  { x: 308, y: 320 }, m4Post: { x: 305, y: 377 },
    m5Pre:  { x: 475, y: 265 }, m5Post: { x: 465, y: 323 },
    entrada:{ x: 580, y: 305 }, salida: { x: 700, y: 298 },
  ...
  // ===================== PÁGINA 2 - OSMOSIS 2 (3 membranas, agua blanda) =====================
    const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 210, y: 140 }, m1Post: { x: 195, y: 218 },
    m2Pre:  { x: 318, y: 140 }, m2Post: { x: 317, y: 218 },
    m3Pre:  { x: 428, y: 140 }, m3Post: { x: 440, y: 218 },
    entrada:{ x: 547, y: 180 }, salida: { x: 665, y: 165 },
