...
export async function generarPdfSemestral5s3s2oBlob(datos) {
  const {
    cliente,
    ...
    // Osmosis 2 (3 membranas, agua blanda)
  ...
  const plantillaUrl = '/plantillas/Plantilla_informe_matencion_5s_3s_2o.pdf'
  ...
  // ===================== PÁGINA 1 - OSMOSIS 1 (5 membranas) =====================
    ...
    m1Pre:  { x: 199, y: 215 }, m1Post: { x: 184, y: 271 },
    m2Pre:  { x: 322, y: 217 }, m2Post: { x: 305, y: 271 },
    m3Pre:  { x: 195, y: 323 }, m3Post: { x: 186, y: 379 },
    m4Pre:  { x: 315, y: 320 }, m4Post: { x: 309, y: 379 },
    m5Pre:  { x: 453, y: 266 }, m5Post: { x: 448, y: 326 },
    entrada:{ x: 574, y: 320 }, salida: { x: 697, y: 298 },
    parrafoConcl: { x: 18, y: 470, size: 11, color: negro, lineHeight: 14, ancho: 790 },
  }
  ...
  const yFinConcl1 = parrafoEn(pag1, `Después del procedimiento de lavado químico (ac. cítrico como desincrustante y ac. peracético como desinfectante), el sistema quedo con una mejor performance, conductividad de salida de ${o1cds} µS/cm, con lo cual estamos en una RR cercana al ${rr1Texto}% ${valFinal1}. También se verificaron los flujos normales ${litros}. La presión de rechazo quedo en ${o1pd} psi y ${o1fp} lpm de flujo producto.`, c1.parrafoConcl)
  const obs1 = (o1observacion || '').trim()
  if (obs1) parrafoEn(pag1, `Observación: ${obs1}`, { ...c1.parrafoConcl, y: yFinConcl1 + 6 })

  // ===================== PÁGINA 2 - OSMOSIS 2 (3 membranas, agua blanda) =====================
    const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 210, y: 143 }, m1Post: { x: 195, y: 211 },
    m2Pre:  { x: 318, y: 144 }, m2Post: { x: 314, y: 211 },
    m3Pre:  { x: 428, y: 144 }, m3Post: { x: 434, y: 211 },
    entrada:{ x: 535, y: 180 }, salida: { x: 652, y: 165 },
    parrafoConcl: { x: 18, y: 330, size: 11, color: negro, lineHeight: 14, ancho: 790 },
    xFirma: 363, yFirma: 492, xNombre: 415, yNombre: 506,
  }
  ...
  const yFinConcl2 = parrafoEn(pag2, `Después del procedimiento de lavado químico (ac. cítrico como desincrustante y ac. peracético como desinfectante), el sistema quedo con una mejor performance, conductividad de salida de ${o2cds} µS/cm, con lo cual estamos en una RR cercana al ${rr2Texto}% ${valFinal2}. También se verificaron los flujos normales ${litros}. La presión de rechazo quedo en ${o2pd} psi y ${o2fp} lpm de flujo producto.`, c2.parrafoConcl)
