...
export async function generarPdfSemestral5s3s2oBlob(datos) {
  ...
  // ===================== PÁGINA 1 - OSMOSIS 1 (5 membranas) =====================
    ...
    m1Pre:  { x: 192, y: 215 }, m1Post: { x: 184, y: 271 },
    m2Pre:  { x: 319, y: 216 }, m2Post: { x: 305, y: 271 },
    m3Pre:  { x: 185, y: 323 }, m3Post: { x: 180, y: 379 },
    m4Pre:  { x: 312, y: 320 }, m4Post: { x: 309, y: 379 },
    m5Pre:  { x: 450, y: 266 }, m5Post: { x: 448, y: 326 },
    entrada:{ x: 578, y: 320 }, salida: { x: 697, y: 298 },
  ...
  // ===================== PÁGINA 2 - OSMOSIS 2 (3 membranas, agua blanda) =====================
    ...
    m2Pre:  { x: 318, y: 144 }, m2Post: { x: 317, y: 212 },
    m3Pre:  { x: 428, y: 143 }, m3Post: { x: 440, y: 212 },
    entrada:{ x: 541, y: 180 }, salida: { x: 655, y: 165 },
