...
export async function generarPdfSemestral5s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 178, y: 200 }, m1Post: { x: 178, y: 260 },
    m2Pre:  { x: 300, y: 200 }, m2Post: { x: 298, y: 260 },
    m3Pre:  { x: 170, y: 309 }, m3Post: { x: 170, y: 367 },
    m4Pre:  { x: 300, y: 310 }, m4Post: { x: 300, y: 365 },
    m5Pre:  { x: 482, y: 248 }, m5Post: { x: 480, y: 310 },
    entrada:{ x: 580, y: 280 }, salida: { x: 700, y: 270 },
    parrafoConcl: { x: 18, y: 430, size: 11, color: negro, lineHeight: 14, ancho: 790 },
  }
  ...
  const c2 = {
    cliente:  { x: 665, y: 73},
    m1Pre:  { x: 230, y: 145 }, m1Post: { x: 250, y: 215.5 },
    m2Pre:  { x: 480, y: 144 }, m2Post: { x: 480, y: 214.5 },
    entrada:{ x: 492, y: 300 }, salida: { x: 615, y: 260 },
