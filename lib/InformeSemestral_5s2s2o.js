...
export async function generarPdfSemestral5s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 170, y: 208 }, m1Post: { x: 169, y: 270 },
    m2Pre:  { x: 300, y: 208 }, m2Post: { x: 296, y: 270 },
    m3Pre:  { x: 162, y: 314 }, m3Post: { x: 160, y: 374 },
    m4Pre:  { x: 300, y: 314 }, m4Post: { x: 300, y: 370 },
    m5Pre:  { x: 480, y: 251 }, m5Post: { x: 478, y: 313 },
    entrada:{ x: 582, y: 290 }, salida: { x: 705, y: 280 },
  ...
  const c2 = {
    cliente:  { x: 665, y: 73},
    m1Pre:  { x: 240, y: 147 }, m1Post: { x: 250, y: 216 },
    m2Pre:  { x: 495, y: 147 }, m2Post: { x: 496, y: 216 },
    entrada:{ x: 492, y: 285 }, salida: { x: 615, y: 265 },
