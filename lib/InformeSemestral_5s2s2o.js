...
export async function generarPdfSemestral5s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 170, y: 213 }, m1Post: { x: 169, y: 275 },
    m2Pre:  { x: 300, y: 212 }, m2Post: { x: 296, y: 278 },
    m3Pre:  { x: 160, y: 320 }, m3Post: { x: 156, y: 380 },
    m4Pre:  { x: 300, y: 317 }, m4Post: { x: 300, y: 376 },
    m5Pre:  { x: 480, y: 251 }, m5Post: { x: 478, y: 316 },
    entrada:{ x: 583, y: 295 }, salida: { x: 705, y: 280 },
  ...
  const c2 = {
    cliente:  { x: 665, y: 73},
    m1Pre:  { x: 285, y: 149 }, m1Post: { x: 280, y: 216 },
    m2Pre:  { x: 510, y: 149 }, m2Post: { x: 510, y: 217 },
