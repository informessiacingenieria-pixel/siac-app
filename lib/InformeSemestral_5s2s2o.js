...
export async function generarPdfSemestral5s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 182, y: 189 }, m1Post: { x: 182, y: 242 },
    m2Pre:  { x: 300, y: 189 }, m2Post: { x: 299, y: 242 },
    m3Pre:  { x: 203, y: 295 }, m3Post: { x: 200, y: 353 },
    m4Pre:  { x: 312, y: 295 }, m4Post: { x: 310, y: 355 },
    m5Pre:  { x: 482, y: 234 }, m5Post: { x: 482, y: 304 },
    entrada:{ x: 570, y: 265 }, salida: { x: 683, y: 250 },
    parrafoConcl: { x: 18, y: 408, size: 11, color: negro, lineHeight: 14, ancho: 790 },
  }
