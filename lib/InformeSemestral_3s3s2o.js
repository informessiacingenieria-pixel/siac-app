...
export async function generarPdfSemestral3s3s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 233, y: 226 }, m1Post: { x: 220, y: 292.5 },
    m2Pre:  { x: 338, y: 226 }, m2Post: { x: 330, y: 291.5 },
    m3Pre:  { x: 444, y: 226 }, m3Post: { x: 445, y: 292.5 },
    entrada:{ x: 568.5, y: 250 }, salida: { x: 685, y: 232 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 224, y: 161 }, m1Post: { x: 205, y: 226 },
    m2Pre:  { x: 318, y: 161 }, m2Post: { x: 317.5, y: 226 },
    m3Pre:  { x: 428, y: 161 }, m3Post: { x: 440, y: 226 },
    entrada:{ x: 555.5, y: 185 }, salida: { x: 680, y: 165 },
