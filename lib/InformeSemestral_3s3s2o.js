...
export async function generarPdfSemestral3s3s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 280, y: 218 }, m1Post: { x: 280, y: 310 },
    m2Pre:  { x: 350, y: 218 }, m2Post: { x: 320, y: 295 },
    m3Pre:  { x: 550, y: 218 }, m3Post: { x: 400, y: 295 },
    entrada:{ x: 750, y: 258 }, salida: { x: 950, y: 232 },
    parrafoConcl: { x: 20, y: 395, size: 11, color: negro, lineHeight: 14, ancho: 770 },
  }
  ...
  const c2 = {
    m1Pre:  { x: 290, y: 170 }, m1Post: { x: 190, y: 250 },
    m2Pre:  { x: 420, y: 170 }, m2Post: { x: 400, y: 250 },
    m3Pre:  { x: 640, y: 190 }, m3Post: { x: 620, y: 250 },
    entrada:{ x: 750, y: 258 }, salida: { x: 900, y: 232 },
    parrafoConcl: { x: 20, y: 385, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    xFirma: 375, yFirma: 480, xNombre: 430, yNombre: 505,
  }
