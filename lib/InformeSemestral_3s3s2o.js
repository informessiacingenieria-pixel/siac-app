...
export async function generarPdfSemestral3s3s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 265, y: 220 }, m1Post: { x: 260, y: 294 },
    m2Pre:  { x: 340, y: 220 }, m2Post: { x: 322, y: 294 },
    m3Pre:  { x: 400, y: 224 }, m3Post: { x: 420, y: 294 },
    entrada:{ x: 680, y: 256 }, salida: { x: 800, y: 232 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 270, y: 165 }, m1Post: { x: 293, y: 245 },
    m2Pre:  { x: 350, y: 165 }, m2Post: { x: 320, y: 242 },
    m3Pre:  { x: 500, y: 165 }, m3Post: { x: 520, y: 258 },
    entrada:{ x: 700, y: 200 }, salida: { x: 800, y: 200 },
    parrafoConcl: { x: 20, y: 370, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    xFirma: 375, yFirma: 485, xNombre: 420, yNombre: 505,
  }
