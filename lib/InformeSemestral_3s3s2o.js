...
export async function generarPdfSemestral3s3s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 245, y: 224 }, m1Post: { x: 240, y: 293 },
    m2Pre:  { x: 338, y: 224 }, m2Post: { x: 324, y: 293 },
    m3Pre:  { x: 420, y: 224 }, m3Post: { x: 430, y: 294 },
    entrada:{ x: 600, y: 250 }, salida: { x: 700, y: 232 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 250, y: 161 }, m1Post: { x: 240, y: 235 },
    m2Pre:  { x: 310, y: 160 }, m2Post: { x: 316, y: 235 },
    m3Pre:  { x: 420, y: 161 }, m3Post: { x: 450, y: 210 },
    entrada:{ x: 600, y: 150 }, salida: { x: 700, y: 160 },
    parrafoConcl: { x: 20, y: 370, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    xFirma: 370, yFirma: 485, xNombre: 415, yNombre: 505,
  }
