...
export async function generarPdfSemestral3s3s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 225, y: 226 }, m1Post: { x: 218, y: 292.5 },
    m2Pre:  { x: 338, y: 226 }, m2Post: { x: 330, y: 291.5 },
    m3Pre:  { x: 444, y: 226 }, m3Post: { x: 445, y: 292.5 },
    entrada:{ x: 571, y: 250 }, salida: { x: 685, y: 232 },
    parrafoConcl: { x: 18, y: 405, size: 11, color: negro, lineHeight: 14, ancho: 790 },
  }
