...
export async function generarPdfSemestral3s3s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 240, y: 226 }, m1Post: { x: 230, y: 292.5 },
    m2Pre:  { x: 338, y: 226 }, m2Post: { x: 330, y: 291.5 },
    m3Pre:  { x: 430, y: 226 }, m3Post: { x: 440, y: 292.5 },
    entrada:{ x: 670, y: 250 }, salida: { x: 685, y: 232 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 260, y: 161 }, m1Post: { x: 190, y: 230 },
    m2Pre:  { x: 315, y: 161 }, m2Post: { x: 316, y: 232 },
    m3Pre:  { x: 425, y: 161 }, m3Post: { x: 440, y: 220 },
    entrada:{ x: 550, y: 170 }, salida: { x: 680, y: 165 },
    parrafoConcl: { x: 20, y: 370, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    xFirma: 365, yFirma: 486, xNombre: 415, yNombre: 505,
  }
