...
export async function generarPdfSemestral6sCarmenBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 257, y: 237 }, m1Post: { x: 199, y: 301 },
    m2Pre:  { x: 221, y: 361 }, m2Post: { x: 217, y: 301 },
    m3Pre:  { x: 361, y: 237 }, m3Post: { x: 312, y: 301 },
    m4Pre:  { x: 333, y: 361 }, m4Post: { x: 320, y: 427 },
    m5Pre:  { x: 465, y: 237 }, m5Post: { x: 418, y: 301 },
    m6Pre:  { x: 444, y: 359 }, m6Post: { x: 430, y: 427 },
