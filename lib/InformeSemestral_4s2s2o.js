...
export async function generarPdfSemestral4s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 240, y: 214 }, m1Post: { x: 240, y: 288 },
    m2Pre:  { x: 380, y: 214 }, m2Post: { x: 383, y: 288 },
    m3Pre:  { x: 515, y: 214 }, m3Post: { x: 515, y: 288 },
    m4Pre:  { x: 660, y: 212 }, m4Post: { x: 648, y: 284 },
    entrada:{ x: 415, y: 358 }, salida: { x: 540, y: 300 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 285, y: 142 }, m1Post: { x: 285, y: 210 },
    m2Pre:  { x: 395, y: 142 }, m2Post: { x: 400, y: 205 },
    entrada:{ x: 500, y: 160 }, salida: { x: 600, y: 140 },
