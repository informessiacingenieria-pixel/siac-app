...
export async function generarPdfSemestral4s2s2oBlob(datos) {
  const {
    cliente,
  ...
  const plantillaUrl = '/plantillas/Plantilla_informe_matencion_4s_2s_2o.pdf'
  ...
  const c1 = {
    ...
    m1Pre:  { x: 240, y: 214 }, m1Post: { x: 240, y: 286 },
    m2Pre:  { x: 374, y: 214 }, m2Post: { x: 380, y: 288 },
    m3Pre:  { x: 508, y: 214 }, m3Post: { x: 515, y: 288 },
    m4Pre:  { x: 640, y: 212 }, m4Post: { x: 648, y: 288 },
    entrada:{ x: 422, y: 362 }, salida: { x: 540, y: 348 },
    parrafoConcl: { x: 18, y: 425, size: 11, color: negro, lineHeight: 14, ancho: 790 },
  }
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 276, y: 140 }, m1Post: { x: 280, y: 205 },
    m2Pre:  { x: 395, y: 140 }, m2Post: { x: 400, y: 205 },
    entrada:{ x: 500, y: 168 }, salida: { x: 613, y: 151 },
    parrafoConcl: { x: 18, y: 350, size: 11, color: negro, lineHeight: 14, ancho: 790 },
