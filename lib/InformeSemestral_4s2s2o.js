...
export async function generarPdfSemestral4s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 240, y: 214 }, m1Post: { x: 240, y: 284 },
    m2Pre:  { x: 374, y: 214 }, m2Post: { x: 380, y: 288 },
    m3Pre:  { x: 508, y: 214 }, m3Post: { x: 515, y: 288 },
    m4Pre:  { x: 645, y: 212 }, m4Post: { x: 648, y: 288 },
    entrada:{ x: 415, y: 360 }, salida: { x: 540, y: 380 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 280, y: 142 }, m1Post: { x: 280, y: 205 },
    m2Pre:  { x: 395, y: 142 }, m2Post: { x: 400, y: 205 },
    entrada:{ x: 500, y: 168 }, salida: { x: 613, y: 148 },
