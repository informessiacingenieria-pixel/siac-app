...
export async function generarPdfSemestral4s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    entrada:{ x: 420, y: 362 }, salida: { x: 540, y: 350 },
    parrafoConcl: { x: 20, y: 425, size: 11, color: negro, lineHeight: 14, ancho: 770 },
  }
  ...
  const c2 = {
    ...
    parrafoConcl: { x: 20, y: 350, size: 11, color: negro, lineHeight: 14, ancho: 770 },
