...
export async function generarPdfSemestral4s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 240, y: 212 }, m1Post: { x: 240, y: 290 },
    m2Pre:  { x: 385, y: 212 }, m2Post: { x: 385, y: 290 },
    m3Pre:  { x: 530, y: 212 }, m3Post: { x: 530, y: 290 },
    m4Pre:  { x: 650, y: 212 }, m4Post: { x: 650, y: 280 },
    entrada:{ x: 400, y: 258 }, salida: { x: 500, y: 232 },
    parrafoConcl: { x: 20, y: 410, size: 11, color: negro, lineHeight: 14, ancho: 770 },
  }
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 300, y: 150 }, m1Post: { x: 220, y: 250 },
    m2Pre:  { x: 400, y: 150 }, m2Post: { x: 400, y: 200 },
    entrada:{ x: 500, y: 200 }, salida: { x: 650, y: 200 },
