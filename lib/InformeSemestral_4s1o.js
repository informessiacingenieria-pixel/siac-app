...
export async function generarPdfSemestral4s1oBlob(datos) {
  ...
  const c = {
    ...
    // 4 membranas en fila
    m1Pre:  { x: 200, y: 215 }, m1Post: { x: 200, y: 285 },
    m2Pre:  { x: 300, y: 215 }, m2Post: { x: 300, y: 285 },
    m3Pre:  { x: 350, y: 215 }, m3Post: { x: 350, y: 285 },
    m4Pre:  { x: 400, y: 215 }, m4Post: { x: 400, y: 285 },

    entrada:{ x: 500, y: 200 }, salida: { x: 600, y: 200 },

    parrafoConcl: { x: 20, y: 380, size: 11, color: negro, lineHeight: 14, ancho: 770 },

    xFirma: 375, yFirma: 480, xNombre: 425, yNombre: 500,
  }
