...
export async function generarPdfSemestral4s1oBlob(datos) {
  ...
  const c = {
    ...
    // 4 membranas en fila
    m1Pre:  { x: 150, y: 218 }, m1Post: { x: 150, y: 280 },
    m2Pre:  { x: 250, y: 218 }, m2Post: { x: 250, y: 280 },
    m3Pre:  { x: 400, y: 218 }, m3Post: { x: 390, y: 280 },
    m4Pre:  { x: 500, y: 218 }, m4Post: { x: 500, y: 280 },

    entrada:{ x: 600, y: 300 }, salida: { x: 700, y: 250 },

    parrafoConcl: { x: 20, y: 380, size: 11, color: negro, lineHeight: 14, ancho: 770 },

    xFirma: 370, yFirma: 490, xNombre: 415, yNombre: 510,
  }
