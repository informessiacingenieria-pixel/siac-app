...
export async function generarPdfSemestral4s1oBlob(datos) {
  ...
  const c = {
    ...
    parrafoConcl: { x: 18, y: 380, size: 11, color: negro, lineHeight: 14, ancho: 790 },
  ...
  const yFinConcl1 = parrafo(`Después del procedimiento de lavado químico (ac. cítrico como desincrustante y ac. peracético como desinfectante), el sistema quedo con una mejor performance, conductividad de salida de ${cds} µS/cm, con lo cual estamos en una RR cercana al ${rrTexto}% ${valFinal}. También se verificaron los flujos normales (3-5 lts. por membrana). La presión de rechazo quedo en ${pd} psi y ${fp} lpm de flujo producto.`, c.parrafoConcl)
