...
export async function generarPdfSemestral4s1oBlob(datos) {
  ...
  const c = {
    ...
    // 4 membranas en fila
    m1Pre:  { x: 153, y: 218 }, m1Post: { x: 153, y: 280 },
    m2Pre:  { x: 270, y: 218 }, m2Post: { x: 270, y: 280 },
    m3Pre:  { x: 370, y: 218 }, m3Post: { x: 370, y: 280 },
    m4Pre:  { x: 480, y: 218 }, m4Post: { x: 480, y: 280 },

    entrada:{ x: 550, y: 250 }, salida: { x: 700, y: 220 },

    parrafoConcl: { x: 20, y: 380, size: 11, color: negro, lineHeight: 14, ancho: 770 },

    xFirma: 363, yFirma: 500, xNombre: 415, yNombre: 501,
  }
