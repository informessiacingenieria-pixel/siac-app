...
export async function generarPdfSemestral6t3s2oBlob(datos) {
  const {
    cliente,
  ...
  const plantillaUrl = '/plantillas/Plantilla_informe_matencion_6m_3s_2o.pdf'
  ...
  const c1 = {
    ...
    m1Pre:  { x: 229, y: 215 }, m1Post: { x: 226, y: 284 },
    m2Pre:  { x: 370, y: 219 }, m2Post: { x: 357, y: 283 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 224, y: 320 }, m3Post: { x: 217, y: 381 },
    m4Pre:  { x: 366, y: 321 }, m4Post: { x: 360, y: 380 },
    m5Pre:  { x: 543, y: 256 }, m5Post: { x: 540, y: 321 },
    m6Pre:  { x: 681, y: 256 }, m6Post: { x: 681, y: 321 },
    entrada:{ x: 520, y: 402 }, salida: { x: 663, y: 389 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 183, y: 157 }, m1Post: { x: 172, y: 220 },
    m2Pre:  { x: 291, y: 157 }, m2Post: { x: 283, y: 220 },
    m3Pre:  { x: 406, y: 157 }, m3Post: { x: 401, y: 220 },
    entrada:{ x: 537, y: 185 }, salida: { x: 650, y: 175 },
    parrafoConcl: { x: 18, y: 340, size: 11, color: negro, lineHeight: 14, ancho: 790 },
    xFirma: 370, yFirma: 492, xNombre: 415, yNombre: 505,
  }
