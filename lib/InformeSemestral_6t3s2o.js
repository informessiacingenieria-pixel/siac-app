...
export async function generarPdfSemestral6t3s2oBlob(datos) {
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 183, y: 157 }, m1Post: { x: 172, y: 222 },
    m2Pre:  { x: 291, y: 157 }, m2Post: { x: 283, y: 222 },
    m3Pre:  { x: 406, y: 157 }, m3Post: { x: 401, y: 223 },
    entrada:{ x: 537, y: 185 }, salida: { x: 650, y: 175 },
    parrafoConcl: { x: 18, y: 370, size: 11, color: negro, lineHeight: 14, ancho: 790 },
    xFirma: 367, yFirma: 492, xNombre: 415, yNombre: 505,
  }
