...
export async function generarPdfSemestral7m4s2oBlob(datos) {
  const {
    cliente,
  ...
  const plantillaUrl = '/plantillas/Plantilla_informe_matencion_7m_4s_2o.pdf'
  ...
  const c1 = {
    ...
    m1Pre:  { x: 199, y: 214 }, m1Post: { x: 189, y: 280 },
    m2Pre:  { x: 358, y: 216 }, m2Post: { x: 310, y: 280 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 200, y: 330 }, m3Post: { x: 215, y: 394 },
    m4Pre:  { x: 318, y: 330 }, m4Post: { x: 328, y: 394 },
    m5Pre:  { x: 419, y: 272 }, m5Post: { x: 444, y: 336 },
    m6Pre:  { x: 538, y: 270 }, m6Post: { x: 561, y: 336 },
    m7Pre:  { x: 654, y: 272 }, m7Post: { x: 676, y: 336 },
    entrada:{ x: 475, y: 420 }, salida: { x: 618, y: 404 },
    parrafoConcl: { x: 18, y: 506, size: 11, color: negro, lineHeight: 14, ancho: 790 },
  }
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 226, y: 136 }, m1Post: { x: 220, y: 212 },
    m2Pre:  { x: 367, y: 137 }, m2Post: { x: 355, y: 212 },
    m3Pre:  { x: 496, y: 138 }, m3Post: { x: 497, y: 212 },
    m4Pre:  { x: 636, y: 138 }, m4Post: { x: 627, y: 212 },
    entrada:{ x: 437, y: 284 }, salida: { x: 562, y: 275 },
    parrafoConcl: { x: 18, y: 344, size: 11, color: negro, lineHeight: 14, ancho: 790 },
