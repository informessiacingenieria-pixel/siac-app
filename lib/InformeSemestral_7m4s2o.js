...
export async function generarPdfSemestral7m4s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 199, y: 214 }, m1Post: { x: 189, y: 281 },
    m2Pre:  { x: 363, y: 216 }, m2Post: { x: 310, y: 283 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 200, y: 333 }, m3Post: { x: 215, y: 398 },
    m4Pre:  { x: 318, y: 330 }, m4Post: { x: 328, y: 396 },
    m5Pre:  { x: 521, y: 273 }, m5Post: { x: 444, y: 337 },
    m6Pre:  { x: 538, y: 270 }, m6Post: { x: 561, y: 338 },
    m7Pre:  { x: 654, y: 272 }, m7Post: { x: 676, y: 337 },
    entrada:{ x: 475, y: 420 }, salida: { x: 618, y: 402 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 226, y: 136 }, m1Post: { x: 220, y: 214 },
    m2Pre:  { x: 367, y: 137 }, m2Post: { x: 355, y: 215 },
    m3Pre:  { x: 496, y: 138 }, m3Post: { x: 497, y: 214 },
    m4Pre:  { x: 636, y: 138 }, m4Post: { x: 627, y: 214 },
