...
export async function generarPdfSemestral6m6m2oBlob(datos) {
  ...
  const c1 = {
    ...
    m4Pre:  { x: 366, y: 321 }, m4Post: { x: 360, y: 381 },
    m5Pre:  { x: 543, y: 256 }, m5Post: { x: 540, y: 321 },
    m6Pre:  { x: 672, y: 256 }, m6Post: { x: 674, y: 321 },
    entrada:{ x: 521, y: 402 }, salida: { x: 656, y: 391 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 177, y: 154 }, m1Post: { x: 163, y: 216 },
    m2Pre:  { x: 320, y: 150 }, m2Post: { x: 302, y: 215 },
    m3Pre:  { x: 177, y: 255 }, m3Post: { x: 165, y: 317 },
    m4Pre:  { x: 313, y: 253 }, m4Post: { x: 307, y: 312 },
