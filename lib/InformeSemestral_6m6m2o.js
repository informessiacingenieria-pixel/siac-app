...
export async function generarPdfSemestral6m6m2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 229, y: 227 }, m1Post: { x: 227, y: 295 },
    m2Pre:  { x: 367, y: 226 }, m2Post: { x: 357, y: 288 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 226, y: 328 }, m3Post: { x: 220, y: 389 },
    m4Pre:  { x: 369, y: 327 }, m4Post: { x: 360, y: 385 },
    m5Pre:  { x: 543, y: 256 }, m5Post: { x: 540, y: 321 },
    m6Pre:  { x: 675, y: 402 }, m6Post: { x: 674, y: 321 },
    entrada:{ x: 525, y: 402 }, salida: { x: 662, y: 385 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 135, y: 156 }, m1Post: { x: 163, y: 220 },
    m2Pre:  { x: 324, y: 156 }, m2Post: { x: 302, y: 226 },
    m3Pre:  { x: 178, y: 260 }, m3Post: { x: 165, y: 328 },
    m4Pre:  { x: 313, y: 259 }, m4Post: { x: 307, y: 319 },
    m5Pre:  { x: 491, y: 195 }, m5Post: { x: 487, y: 264 },
    m6Pre:  { x: 628, y: 193 }, m6Post: { x: 627, y: 256 },
    entrada:{ x: 472, y: 336 }, salida: { x: 609, y: 317 },
