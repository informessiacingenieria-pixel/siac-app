...
export async function generarPdfSemestral6m6m2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 229, y: 224 }, m1Post: { x: 226, y: 285 },
    m2Pre:  { x: 367, y: 224 }, m2Post: { x: 357, y: 285 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 224, y: 325 }, m3Post: { x: 217, y: 384 },
    m4Pre:  { x: 366, y: 325 }, m4Post: { x: 360, y: 361 },
    m5Pre:  { x: 543, y: 256 }, m5Post: { x: 540, y: 321 },
    m6Pre:  { x: 673, y: 256 }, m6Post: { x: 674, y: 321 },
    entrada:{ x: 521, y: 402 }, salida: { x: 656, y: 385 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 177, y: 152 }, m1Post: { x: 163, y: 218 },
    m2Pre:  { x: 320, y: 154 }, m2Post: { x: 302, y: 215 },
    m3Pre:  { x: 179, y: 255 }, m3Post: { x: 165, y: 317 },
    m4Pre:  { x: 313, y: 256 }, m4Post: { x: 307, y: 314 },
    m5Pre:  { x: 491, y: 191 }, m5Post: { x: 487, y: 254 },
    m6Pre:  { x: 627, y: 190 }, m6Post: { x: 627, y: 254 },
    entrada:{ x: 472, y: 333 }, salida: { x: 609, y: 317 },
    parrafoConcl: { x: 18, y: 407, size: 11, color: negro, lineHeight: 14, ancho: 790 },
    xFirma: 355, yFirma: 502, xNombre: 415, yNombre: 506,
  }
