...
export async function generarPdfSemestral5s1oBlob(datos) {
  ...
  const c = {
    ...
    // 5 membranas en fila
    m1Pre:  { x: 182, y: 200 }, m1Post: { x: 182, y: 220 },
    m2Pre:  { x: 302, y: 195 }, m2Post: { x: 303, y: 247 },
    m3Pre:  { x: 203, y: 302 }, m3Post: { x: 200, y: 335 },
    m4Pre:  { x: 305, y: 302 }, m4Post: { x: 306, y: 332 },
    m5Pre:  { x: 510, y: 227 }, m5Post: { x: 509, y: 304 },

    entrada:{ x: 540, y: 261 }, salida: { x: 640, y: 310 },
