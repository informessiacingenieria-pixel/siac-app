...
export async function generarPdfSemestral5s1oBlob(datos) {
  ...
  const c = {
    ...
    // 5 membranas en fila
    m1Pre:  { x: 190, y: 200 }, m1Post: { x: 190, y: 200 },
    m2Pre:  { x: 310, y: 200 }, m2Post: { x: 310, y: 250 },
    m3Pre:  { x: 200, y: 310 }, m3Post: { x: 200, y: 320 },
    m4Pre:  { x: 290, y: 310 }, m4Post: { x: 290, y: 320 },
    m5Pre:  { x: 520, y: 220 }, m5Post: { x: 520, y: 304 },

    entrada:{ x: 500, y: 258 }, salida: { x: 600, y: 232 },
