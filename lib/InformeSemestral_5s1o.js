...
export async function generarPdfSemestral5s1oBlob(datos) {
  ...
  function lineasEn(arr, x, yTop, color = negro, size = 9, lineHeight = 11) {
  ...
  const c = {
    cliente:      { x: 720, y: 120 },
    parrafoIntro: { x: 42, y: 142, size: 11, color: negro, lineHeight: 14, ancho: 790 },

    // 5 membranas en fila
    m1Pre:  { x: 200, y: 210 }, m1Post: { x: 200, y: 300 },
    m2Pre:  { x: 330, y: 210 }, m2Post: { x: 330, y: 300 },
    m3Pre:  { x: 460, y: 210 }, m3Post: { x: 460, y: 300 },
    m4Pre:  { x: 590, y: 210 }, m4Post: { x: 590, y: 300 },
    m5Pre:  { x: 720, y: 210 }, m5Post: { x: 720, y: 300 },

    entrada:{ x: 880, y: 258 }, salida: { x: 1020, y: 232 },

    parrafoConcl: { x: 42, y: 385, size: 11, color: negro, lineHeight: 14, ancho: 790 },
