...
export async function generarPdfSemestral5s1oBlob(datos) {
  ...
  const c = {
    ...
    // 5 membranas en fila
    m1Pre:  { x: 182, y: 192 }, m1Post: { x: 182, y: 230 },
    m2Pre:  { x: 300, y: 192 }, m2Post: { x: 299, y: 243 },
    m3Pre:  { x: 203, y: 298 }, m3Post: { x: 200, y: 343 },
    m4Pre:  { x: 300, y: 298 }, m4Post: { x: 310, y: 340 },
    m5Pre:  { x: 495, y: 232 }, m5Post: { x: 494, y: 304 },

    entrada:{ x: 550, y: 265 }, salida: { x: 680, y: 270 },
