...
export async function generarPdfSemestral6ot4s2oBlob(datos) {
  const {
    cliente,
  ...
  const plantillaUrl = '/plantillas/Plantilla_informe_mantencion_6m_4m_dist_2o.pdf'
  ...
  const c1 = {
    ...
    m1Pre:  { x: 177, y: 212 }, m1Post: { x: 191, y: 272 },
    m2Pre:  { x: 199, y: 318 }, m2Post: { x: 194, y: 370 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 301, y: 256 }, m3Post: { x: 326, y: 322 },
    m4Pre:  { x: 410, y: 256 }, m4Post: { x: 425, y: 322 },
    m5Pre:  { x: 517, y: 256 }, m5Post: { x: 532, y: 322 },
    m6Pre:  { x: 620, y: 256 }, m6Post: { x: 650, y: 322 },
    entrada:{ x: 503, y: 402 }, salida: { x: 626, y: 385 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 135, y: 163 }, m1Post: { x: 134, y: 222 },
    m2Pre:  { x: 241, y: 162 }, m2Post: { x: 241, y: 222 },
    m3Pre:  { x: 341, y: 162 }, m3Post: { x: 340, y: 222 },
    m4Pre:  { x: 442, y: 162 }, m4Post: { x: 445, y: 222 },
    entrada:{ x: 552, y: 191 }, salida: { x: 670, y: 175 },
    parrafoConcl: { x: 18, y: 335, size: 11, color: negro, lineHeight: 14, ancho: 790 },
