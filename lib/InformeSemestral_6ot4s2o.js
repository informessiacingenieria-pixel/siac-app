...
export async function generarPdfSemestral6ot4s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 230, y: 290 }, m1Post: { x: 230, y: 335 },
    m2Pre:  { x: 230, y: 400 }, m2Post: { x: 230, y: 445 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 400, y: 335 }, m3Post: { x: 400, y: 400 },
    m4Pre:  { x: 500, y: 335 }, m4Post: { x: 500, y: 400 },
    m5Pre:  { x: 600, y: 335 }, m5Post: { x: 600, y: 400 },
    m6Pre:  { x: 700, y: 335 }, m6Post: { x: 700, y: 400 },
    entrada:{ x: 400, y: 460 }, salida: { x: 550, y: 445 },
