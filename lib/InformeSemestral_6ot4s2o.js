...
export async function generarPdfSemestral6ot4s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 180, y: 210 }, m1Post: { x: 195, y: 260 },
    m2Pre:  { x: 200, y: 360 }, m2Post: { x: 200, y: 380 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 330, y: 280 }, m3Post: { x: 330, y: 310 },
    m4Pre:  { x: 410, y: 280 }, m4Post: { x: 422, y: 3000 },
    m5Pre:  { x: 520, y: 280 }, m5Post: { x: 520, y: 300 },
    m6Pre:  { x: 620, y: 290 }, m6Post: { x: 620, y: 300 },
    entrada:{ x: 511, y: 390 }, salida: { x: 620, y: 380 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 134, y: 160 }, m1Post: { x: 134, y: 220 },
    m2Pre:  { x: 252, y: 160 }, m2Post: { x: 251, y: 220 },
    m3Pre:  { x: 346, y: 160 }, m3Post: { x: 345, y: 220 },
    m4Pre:  { x: 445, y: 158 }, m4Post: { x: 445, y: 220 },
    entrada:{ x: 547, y: 190 }, salida: { x: 672, y: 172 },
