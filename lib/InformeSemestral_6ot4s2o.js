...
export async function generarPdfSemestral6ot4s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 200, y: 200 }, m1Post: { x: 210, y: 300 },
    m2Pre:  { x: 215, y: 380 }, m2Post: { x: 210, y: 400 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 350, y: 400 }, m3Post: { x: 360, y: 450 },
    m4Pre:  { x: 410, y: 400 }, m4Post: { x: 420, y: 450 },
    m5Pre:  { x: 520, y: 400 }, m5Post: { x: 500, y: 500 },
    m6Pre:  { x: 620, y: 400 }, m6Post: { x: 600, y: 500 },
    entrada:{ x: 510, y: 510 }, salida: { x: 610, y: 510 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 134, y: 153 }, m1Post: { x: 134, y: 217 },
    m2Pre:  { x: 249, y: 152 }, m2Post: { x: 249, y: 217 },
    m3Pre:  { x: 350, y: 152 }, m3Post: { x: 350, y: 217 },
    m4Pre:  { x: 460, y: 153 }, m4Post: { x: 460, y: 217 },
    entrada:{ x: 567, y: 190 }, salida: { x: 680, y: 172 },
