...
export async function generarPdfSemestral6ot4s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 178, y: 211 }, m1Post: { x: 193, y: 265 },
    m2Pre:  { x: 199, y: 345 }, m2Post: { x: 197, y: 372 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 310, y: 265 }, m3Post: { x: 326, y: 318 },
    m4Pre:  { x: 410, y: 265 }, m4Post: { x: 422, y: 315 },
    m5Pre:  { x: 519, y: 265 }, m5Post: { x: 528, y: 315 },
    m6Pre:  { x: 620, y: 265 }, m6Post: { x: 640, y: 320 },
    entrada:{ x: 500, y: 400 }, salida: { x: 624, y: 383 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 135, y: 162 }, m1Post: { x: 134, y: 222 },
    m2Pre:  { x: 248, y: 162 }, m2Post: { x: 246, y: 222 },
    m3Pre:  { x: 344, y: 162 }, m3Post: { x: 343, y: 222 },
    m4Pre:  { x: 444, y: 162 }, m4Post: { x: 445, y: 222 },
    entrada:{ x: 543, y: 190 }, salida: { x: 672, y: 172 },
