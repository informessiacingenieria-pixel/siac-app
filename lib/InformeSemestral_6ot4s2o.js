...
export async function generarPdfSemestral6ot4s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 177, y: 212 }, m1Post: { x: 191, y: 270 },
    m2Pre:  { x: 199, y: 325 }, m2Post: { x: 194, y: 370 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 301, y: 258 }, m3Post: { x: 323, y: 320 },
    m4Pre:  { x: 410, y: 258 }, m4Post: { x: 423, y: 318 },
    m5Pre:  { x: 517, y: 258 }, m5Post: { x: 530, y: 318 },
    m6Pre:  { x: 620, y: 258 }, m6Post: { x: 650, y: 320 },
    entrada:{ x: 500, y: 400 }, salida: { x: 626, y: 383 },
  ...
  lineasEn(pag1, [`Conductividad de`, `entrada`, `${o1cde} µS/cm`], c1.entrada.x, c1.entrada.y, negro, 9, 12)
  ...
  const c2 = {
    ...
    entrada:{ x: 548, y: 190 }, salida: { x: 672, y: 172 },
  ...
  lineasEn(pag2, [`Conductividad de entrada ${o2cde} µS/cm`], c2.entrada.x, c2.entrada.y, negro, 9, 12)
