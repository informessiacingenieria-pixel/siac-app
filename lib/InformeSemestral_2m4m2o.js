...
export async function generarPdfSemestral2m4m2oBlob(datos) {
  ...
  const c1 = {
    cliente:      { x: 680, y: 73 },
    parrafoIntro: { x: 30, y: 132, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    m1Pre:  { x: 230, y: 220 }, m1Post: { x: 217, y: 300 },
    m2Pre:  { x: 450, y: 215 }, m2Post: { x: 355, y: 295 },
    entrada:{ x: 490, y: 230 }, salida: { x: 595, y: 232 },
    parrafoConcl: { x: 30, y: 415, size: 11, color: negro, lineHeight: 14, ancho: 770 },
  }
  ...
  const c2 = {
    m1Pre: { x: 219, y: 175 }, m1Post: { x: 215, y: 240 },
    m2Pre: { x: 352, y: 175 }, m2Post: { x: 345, y: 245 },
    m3Pre: { x: 500, y: 175 }, m3Post: { x: 500, y: 245 },
    m4Pre: { x: 609, y: 175 }, m4Post: { x: 550, y: 245 },
    entrada:{ x: 405, y: 310 }, salida: { x: 525, y: 298 },
    parrafoConcl: { x: 30, y: 375, size: 11, color: negro, lineHeight: 14, ancho: 770 },
