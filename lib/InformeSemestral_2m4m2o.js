...
export async function generarPdfSemestral2m4m2oBlob(datos) {
  ...
  function lineasEn(page, arr, x, yTop, color = negro, size = 11, lineHeight = 11) {
  ...
  const c1 = {
    cliente:      { x: 680, y: 73 },
    parrafoIntro: { x: 30, y: 122, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    m1Pre:  { x: 300, y: 220 }, m1Post: { x: 200, y: 300 },
    m2Pre:  { x: 615, y: 225 }, m2Post: { x: 350, y: 295 },
    entrada:{ x: 500, y: 258 }, salida: { x: 650, y: 232 },
    parrafoConcl: { x: 30, y: 400, size: 11, color: negro, lineHeight: 14, ancho: 770 },
  }
  ...
  parrafoEn(pag1, `Después del procedimiento de lavado químico (ac. cítrico como desincrustante y ac. peracético como desinfectante), la conductividad de salida quedó en ${o1cds} µS/cm, con lo cual estamos en una RR cercana al ${rr1Texto}% ${valFinal1}. También se verificaron los flujos normales (normal 3-5 lts. por membrana). La presión de rechazo quedó en ${o1pd} psi y ${o1fp} lpm de flujo de permeado. Se vuelve a configuración para trabajar como ósmosis en línea.`, c1.parrafoConcl)

  // ===================== PÁGINA 2 - OSMOSIS 2 (4 membranas) =====================
  // Las 4 membranas se distribuyen horizontalmente. Coordenadas de partida (a afinar).
  const c2 = {
    m1Pre: { x: 200, y: 175 }, m1Post: { x: 200, y: 265 },
    m2Pre: { x: 350, y: 175 }, m2Post: { x: 350, y: 265 },
    m3Pre: { x: 500, y: 175 }, m3Post: { x: 500, y: 265 },
    m4Pre: { x: 600, y: 170 }, m4Post: { x: 600, y: 270 },
    entrada:{ x: 410, y: 300 }, salida: { x: 530, y: 290 },
    parrafoConcl: { x: 30, y: 390, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    xFirma: 380, yFirma: 480, xNombre: 415, yNombre: 500,
  }
