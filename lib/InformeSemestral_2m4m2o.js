...
export async function generarPdfSemestral2m4m2oBlob(datos) {
  ...
  function lineasEn(page, arr, x, yTop, color = negro, size = 9, lineHeight = 11) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 355, y: 210 }, m1Post: { x: 175, y: 278 },
    m2Pre:  { x: 615, y: 210 }, m2Post: { x: 300, y: 280 },
    entrada:{ x: 545, y: 258 }, salida: { x: 700, y: 232 },
  ...
  const c2 = {
    m1Pre: { x: 250, y: 195 }, m1Post: { x: 250, y: 285 },
    m2Pre: { x: 400, y: 195 }, m2Post: { x: 400, y: 285 },
    m3Pre: { x: 550, y: 195 }, m3Post: { x: 550, y: 285 },
    m4Pre: { x: 700, y: 195 }, m4Post: { x: 700, y: 285 },
    entrada:{ x: 430, y: 340 }, salida: { x: 570, y: 320 },
    parrafoConcl: { x: 42, y: 420, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    xFirma: 380, yFirma: 480, xNombre: 435, yNombre: 515,
  }
