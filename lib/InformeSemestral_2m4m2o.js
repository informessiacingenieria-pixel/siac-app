...
export async function generarPdfSemestral2m4m2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 200, y: 220 }, m1Post: { x: 215, y: 300 },
    m2Pre:  { x: 550, y: 225 }, m2Post: { x: 360, y: 295 },
    entrada:{ x: 480, y: 230 }, salida: { x: 600, y: 232 },
    parrafoConcl: { x: 30, y: 393, size: 11, color: negro, lineHeight: 14, ancho: 770 },
  }
  ...
  const c2 = {
    m1Pre: { x: 215, y: 175 }, m1Post: { x: 230, y: 250 },
    m2Pre: { x: 350, y: 180 }, m2Post: { x: 345, y: 245 },
    m3Pre: { x: 450, y: 175 }, m3Post: { x: 450, y: 245 },
    m4Pre: { x: 615, y: 175 }, m4Post: { x: 500, y: 275 },
    entrada:{ x: 405, y: 320 }, salida: { x: 520, y: 298 },
    parrafoConcl: { x: 30, y: 375, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    xFirma: 380, yFirma: 490, xNombre: 415, yNombre: 510,
  }
