...
export async function generarPdfSemestral3sOtro1oBlob(datos) {
  ...
  const c1 = {
    cliente:      { x: 680, y: 73 },
    parrafoIntro: { x: 25, y: 130, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    m1Pre:  { x: 320, y: 210 }, m1Post: { x: 320, y: 300 },
    m2Pre:  { x: 490, y: 210 }, m2Post: { x: 490, y: 300 },
    m3Pre:  { x: 660, y: 210 }, m3Post: { x: 660, y: 300 },
    entrada:  { x: 400, y: 380 },
    salida1:  { x: 550, y: 385 },   // Primer paso
    salida2:  { x: 700, y: 385 },   // Segundo paso
  }
  ...
  const c2 = {
    cliente:      { x: 720, y: 120 },
    parrafoConcl: { x: 42, y: 155, size: 11, color: negro, lineHeight: 14, ancho: 1150 },
    nota:         { x: 42, y: 215, size: 11, color: negro, lineHeight: 14, ancho: 1150 },
    xFirma: 560, yFirma: 300, xNombre: 615, yNombre: 340,
  }
