...
export async function generarPdfSemestral3sOtro1oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 254, y: 245 }, m1Post: { x: 180, y: 320 },
    m2Pre:  { x: 390, y: 270 }, m2Post: { x: 290, y: 320 },
    m3Pre:  { x: 560, y: 280 }, m3Post: { x: 560, y: 320 },
    entrada:  { x: 330, y: 390 },
  ...
  const c2 = {
    cliente:      { x: 680, y: 73 },
    parrafoConcl: { x: 20, y: 130, size: 11, color: negro, lineHeight: 14, ancho: 1150 },
    nota:         { x: 20, y: 180, size: 11, color: negro, lineHeight: 14, ancho: 1150 },
    xFirma: 400, yFirma: 420, xNombre: 480, yNombre: 410,
  }
