...
export async function generarPdfSemestral3sOtro1oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 254, y: 245 }, m1Post: { x: 165, y: 320 },
    m2Pre:  { x: 392, y: 245 }, m2Post: { x: 283, y: 320 },
    m3Pre:  { x: 560, y: 245 }, m3Post: { x: 565, y: 320 },
    entrada:  { x: 320, y: 390 },
  ...
  const c2 = {
    ...
    xFirma: 370, yFirma: 420, xNombre: 425, yNombre: 418,
  }
