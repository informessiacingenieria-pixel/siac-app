...
export async function generarPdfSemestral3sOtro1oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 254, y: 245 }, m1Post: { x: 170, y: 315 },
    m2Pre:  { x: 392, y: 245 }, m2Post: { x: 287, y: 320 },
    m3Pre:  { x: 560, y: 260 }, m3Post: { x: 565, y: 320 },
    entrada:  { x: 322, y: 390 },
  ...
  const c2 = {
    ...
    nota:         { x: 20, y: 180, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    xFirma: 380, yFirma: 420, xNombre: 440, yNombre: 416,
  }
