...
export async function generarPdfSemestral3sOtro1oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 250, y: 250 }, m1Post: { x: 200, y: 330 },
    m2Pre:  { x: 380, y: 300 }, m2Post: { x: 250, y: 320 },
    m3Pre:  { x: 550, y: 300 }, m3Post: { x: 550, y: 350 },
    entrada:  { x: 350, y: 390 },
    salida1:  { x: 450, y: 385 },   // Primer paso
    salida2:  { x: 620, y: 385 },   // Segundo paso
  }
  ...
  const c2 = {
    cliente:      { x: 680, y: 73 },
    parrafoConcl: { x: 25, y: 140, size: 11, color: negro, lineHeight: 14, ancho: 1150 },
    nota:         { x: 25, y: 200, size: 11, color: negro, lineHeight: 14, ancho: 1150 },
    xFirma: 450, yFirma: 400, xNombre: 515, yNombre: 380,
  }
