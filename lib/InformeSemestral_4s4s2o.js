...
export async function generarPdfSemestral4s4s2oBlob(datos) {
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 285, y: 143 }, m1Post: { x: 280, y: 210 },
    m2Pre:  { x: 420, y: 143 }, m2Post: { x: 420, y: 210 },
    m3Pre:  { x: 542, y: 143 }, m3Post: { x: 543, y: 210 },
    m4Pre:  { x: 663, y: 143 }, m4Post: { x: 670, y: 210 },
    entrada:{ x: 460, y: 280 }, salida: { x: 580, y: 270 },
    parrafoConcl: { x: 18, y: 355, size: 11, color: negro, lineHeight: 14, ancho: 790 },
