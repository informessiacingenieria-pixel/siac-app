...
export async function generarPdfSemestral3s2s2oBlob(datos) {
  const {
    cliente,
    diaInforme, mesInforme, anioInforme,
    // Osmosis 1 (3 membranas)
  ...
  const plantillaUrl = '/plantillas/Plantilla_informe_matencion_3s_2s_2o.pdf'
  ...
  // ===================== PÁGINA 1 - OSMOSIS 1 (3 membranas) =====================
  const c1 = {
    cliente:      { x: 680, y: 73 },
    parrafoIntro: { x: 20, y: 137, size: 11, color: negro, lineHeight: 14, ancho: 790 },
    m1Pre:  { x: 220, y: 238 }, m1Post: { x: 213, y: 305 },
    m2Pre:  { x: 334, y: 238 }, m2Post: { x: 320, y: 305 },
    m3Pre:  { x: 434, y: 238 }, m3Post: { x: 442, y: 305 },
    entrada:{ x: 526, y: 370 }, salida: { x: 650, y: 350 },
    parrafoConcl: { x: 18, y: 440, size: 11, color: negro, lineHeight: 14, ancho: 790 },
  }
  ...
  // ===================== PÁGINA 2 - OSMOSIS 2 (2 membranas) =====================
  const c2 = {
    cliente:  { x: 680, y: 73},
    m1Pre:  { x: 214, y: 140 }, m1Post: { x: 230, y: 214 },
    m2Pre:  { x: 353, y: 140 }, m2Post: { x: 365, y: 213 },
    entrada:{ x: 490, y: 200 }, salida: { x: 615, y: 180 },
    parrafoConcl: { x: 18, y: 345, size: 11, color: negro, lineHeight: 14, ancho: 790 },
