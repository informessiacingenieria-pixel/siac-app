...
export async function generarPdfSemestral3s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 230, y: 242 }, m1Post: { x: 235, y: 302 },
    m2Pre:  { x: 342, y: 235 }, m2Post: { x: 310, y: 305 },
    m3Pre:  { x: 410, y: 246 }, m3Post: { x: 442, y: 305 },
    entrada:{ x: 450, y: 400 }, salida: { x: 650, y: 400 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73},
    m1Pre:  { x: 210, y: 130 }, m1Post: { x: 200, y: 220 },
    m2Pre:  { x: 350, y: 120 }, m2Post: { x: 300, y: 200 },
