...
export async function generarPdfSemestral3s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 220, y: 241 }, m1Post: { x: 221, y: 305 },
    m2Pre:  { x: 334, y: 2378 }, m2Post: { x: 320, y: 305 },
    m3Pre:  { x: 427, y: 241 }, m3Post: { x: 442, y: 305 },
    entrada:{ x: 515, y: 370 }, salida: { x: 650, y: 350 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73},
    m1Pre:  { x: 214, y: 136 }, m1Post: { x: 222, y: 214 },
    m2Pre:  { x: 353, y: 136 }, m2Post: { x: 360, y: 211.5 },
    entrada:{ x: 495, y: 200 }, salida: { x: 615, y: 180 },
