...
export async function generarPdfSemestral3s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 250, y: 250 }, m1Post: { x: 250, y: 310 },
    m2Pre:  { x: 350, y: 230 }, m2Post: { x: 300, y: 310 },
    m3Pre:  { x: 350, y: 250 }, m3Post: { x: 450, y: 310 },
    entrada:{ x: 400, y: 200 }, salida: { x: 600, y: 200 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73},
    m1Pre:  { x: 250, y: 170 }, m1Post: { x: 215, y: 200 },
    m2Pre:  { x: 400, y: 180 }, m2Post: { x: 750, y: 170 },
