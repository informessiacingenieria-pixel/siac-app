...
export async function generarPdfSemestral3s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 220, y: 239.5 }, m1Post: { x: 218, y: 305 },
    m2Pre:  { x: 334, y: 238 }, m2Post: { x: 320, y: 305 },
    m3Pre:  { x: 431, y: 241 }, m3Post: { x: 442, y: 305 },
    entrada:{ x: 522, y: 370 }, salida: { x: 650, y: 350 },
  ...
  const c2 = {
    ...
    m2Pre:  { x: 353, y: 140 }, m2Post: { x: 364, y: 211.5 },
