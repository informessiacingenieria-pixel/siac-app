...
export async function generarPdfSemestral3s2s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 223, y: 240 }, m1Post: { x: 231, y: 305 },
    m2Pre:  { x: 336, y: 237 }, m2Post: { x: 316, y: 305 },
    m3Pre:  { x: 420, y: 241 }, m3Post: { x: 442, y: 305 },
    entrada:{ x: 500, y: 350 }, salida: { x: 650, y: 300 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73},
    m1Pre:  { x: 213, y: 134 }, m1Post: { x: 215, y: 215 },
    m2Pre:  { x: 353, y: 127 }, m2Post: { x: 350, y: 210 },
    entrada:{ x: 510, y: 200 }, salida: { x: 600, y: 200 },
