...
export async function generarPdfSemestral8m5s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 247, y: 207 }, m1Post: { x: 180, y: 272 },
    m2Pre:  { x: 207, y: 328 }, m2Post: { x: 195, y: 395 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 341, y: 207 }, m3Post: { x: 286, y: 272 },
    m4Pre:  { x: 321, y: 326 }, m4Post: { x: 294, y: 395 },
    m5Pre:  { x: 443, y: 208 }, m5Post: { x: 392, y: 273 },
    m6Pre:  { x: 422, y: 327 }, m6Post: { x: 401, y: 394 },
    m7Pre:  { x: 535, y: 230 }, m7Post: { x: 534, y: 289 },
    m8Pre:  { x: 534, y: 344 }, m8Post: { x: 648, y: 368 },
    entrada:{ x: 409, y: 451 }, salida: { x: 519, y: 439 },
    parrafoConcl: { x: 18, y: 502, size: 11, color: negro, lineHeight: 14, ancho: 790 },
  }
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 197, y: 177 }, m1Post: { x: 191, y: 244 },
    m2Pre:  { x: 312, y: 175 }, m2Post: { x: 317, y: 244 },
    m3Pre:  { x: 427, y: 176 }, m3Post: { x: 434, y: 244 },
    m4Pre:  { x: 544, y: 177 }, m4Post: { x: 550, y: 244 },
    m5Pre:  { x: 657, y: 175 }, m5Post: { x: 660, y: 244 },
