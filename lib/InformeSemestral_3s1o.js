...
export async function generarPdfSemestral3s1oBlob(datos) {
  ...
  const c = {
    cliente:      { x: 680, y: 73 },
    parrafoIntro: { x: 25, y: 142, size: 11, color: negro, lineHeight: 14, ancho: 770 },

    // 3 membranas en fila
    m1Pre:  { x: 200, y: 220 }, m1Post: { x: 250, y: 280 },
    m2Pre:  { x: 200, y: 210 }, m2Post: { x: 290, y: 290 },
    m3Pre:  { x: 400, y: 220 }, m3Post: { x: 300, y: 300 },

    entrada:{ x: 500, y: 258 }, salida: { x: 550, y: 232 },
