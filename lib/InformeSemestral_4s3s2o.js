...
export async function generarPdfSemestral4s3s2oBlob(datos) {
  ...
  const c1 = {
    cliente:      { x: 680, y: 73 },
    parrafoIntro: { x: 18, y: 130, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    m1Pre:  { x: 235, y: 212 }, m1Post: { x: 235, y: 290 },
    m2Pre:  { x: 390, y: 212 }, m2Post: { x: 385, y: 290 },
    m3Pre:  { x: 500, y: 212 }, m3Post: { x: 500, y: 290 },
    m4Pre:  { x: 620, y: 210 }, m4Post: { x: 620, y: 290 },
    entrada:{ x: 422, y: 362 }, salida: { x: 540, y: 348 },
    parrafoConcl: { x: 18, y: 415, size: 11, color: negro, lineHeight: 14, ancho: 770 },
  }
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 280, y: 160 }, m1Post: { x: 285, y: 200 },
    m2Pre:  { x: 400, y: 1600 }, m2Post: { x: 400, y: 200 },
    m3Pre:  { x: 620, y: 150 }, m3Post: { x: 620, y: 200 },
    entrada:{ x: 400, y: 300 }, salida: { x: 500, y: 300 },
    parrafoConcl: { x: 18, y: 365, size: 11, color: negro, lineHeight: 14, ancho: 770 },
