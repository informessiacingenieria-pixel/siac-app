...
export async function generarPdfSemestral4s3s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m2Pre:  { x: 384, y: 214 }, m2Post: { x: 398, y: 288 },
    m3Pre:  { x: 502, y: 214 }, m3Post: { x: 502, y: 288 },
    m4Pre:  { x: 626, y: 214 }, m4Post: { x: 626, y: 288 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 285, y: 150 }, m1Post: { x: 285, y: 208 },
    m2Pre:  { x: 408, y: 150 }, m2Post: { x: 408, y: 208 },
    m3Pre:  { x: 520, y: 140 }, m3Post: { x: 520, y: 206 },
    entrada:{ x: 450, y: 250 }, salida: { x: 600, y: 220 },
