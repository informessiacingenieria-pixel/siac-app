...
export async function generarPdfSemestral4s3s2oBlob(datos) {
  const {
    cliente,
  ...
  const plantillaUrl = '/plantillas/Plantilla_informe_matencion_4s_3s_2o.pdf'
  ...
  // ===================== PÁGINA 2 - OSMOSIS 2 (3 membranas) =====================
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 287, y: 141.5 }, m1Post: { x: 285, y: 211.5 },
    m2Pre:  { x: 414, y: 141.5 }, m2Post: { x: 414, y: 211.5 },
    m3Pre:  { x: 545, y: 140 }, m3Post: { x: 550, y: 210 },
    entrada:{ x: 464, y: 280 }, salida: { x: 585, y: 255 },
