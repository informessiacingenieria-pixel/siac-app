...
export async function generarPdfSemestral4s3s2oBlob(datos) {
  ...
  const c1 = {
    ...
    m2Pre:  { x: 378, y: 214 }, m2Post: { x: 390, y: 288 },
    m3Pre:  { x: 502, y: 214 }, m3Post: { x: 502, y: 288 },
    m4Pre:  { x: 631, y: 214 }, m4Post: { x: 631, y: 288 },
    entrada:{ x: 422, y: 362 }, salida: { x: 540, y: 348 },
    parrafoConcl: { x: 18, y: 435, size: 11, color: negro, lineHeight: 14, ancho: 770 },
  }
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 287, y: 140 }, m1Post: { x: 285, y: 210 },
    m2Pre:  { x: 412, y: 140 }, m2Post: { x: 412, y: 210 },
    m3Pre:  { x: 530, y: 140 }, m3Post: { x: 530, y: 210 },
    entrada:{ x: 460, y: 280 }, salida: { x: 600, y: 270 },
