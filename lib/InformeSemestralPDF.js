...
export async function generarPdfSemestralBlob(datos) {
  ...
  const c = {
    ...
    memb1Pre:   { x: 300, y: 205, size: 10, color: azul,  lineHeight: 11 },
    memb1Post:  { x: 160, y: 275, size: 10, color: verde, lineHeight: 11 },
    memb2Pre:   { x: 500, y: 205, size: 10, color: azul,  lineHeight: 11 },
    memb2Post:  { x: 288, y: 275, size: 10, color: verde, lineHeight: 11 },

    entrada:    { x: 540, y: 245, size: 10, color: negro, lineHeight: 11 },
    salida:     { x: 670, y: 200, size: 10, color: verde, lineHeight: 11 },
