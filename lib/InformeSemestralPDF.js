...
export async function generarPdfSemestralBlob(datos) {
  ...
  const c = {
    ...
    memb1Pre:   { x: 350, y: 210, size: 11, color: azul,  lineHeight: 11 },
    memb1Post:  { x: 160, y: 278, size: 11, color: verde, lineHeight: 11 },
    memb2Pre:   { x: 570, y: 210, size: 11, color: azul,  lineHeight: 11 },
    memb2Post:  { x: 290, y: 280, size: 11, color: verde, lineHeight: 11 },

    entrada:    { x: 545, y: 250, size: 11, color: negro, lineHeight: 11 },
    salida:     { x: 680, y: 245, size: 11, color: verde, lineHeight: 11 },
