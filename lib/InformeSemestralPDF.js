...
export async function generarPdfSemestralBlob(datos) {
  ...
  const c = {
    ...
    xFirma: 377, yFirma: 507,
    xNombreCentro: 415, yNombre: 508,
  }
  ...
  const yFinConcl1 = escribirParrafo(parrafo, c.parrafoConcl)
  const obs1 = (observacion || '').trim()
  if (obs1) escribirParrafo(`Observación: ${obs1}`, { ...c.parrafoConcl, y: yFinConcl1 + 6 })
