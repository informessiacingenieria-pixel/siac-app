...
export async function generarPdfSemestralBlob(datos) {
  ...
  const c = {
    cliente:        { x: 720, y: 120, size: 11, color: negro },
    parrafoIntro:   { x: 42, y: 142, size: 11, color: negro, lineHeight: 14, ancho: 770 },

    memb1Pre:   { x: 355, y: 210, size: 9, color: azul,  lineHeight: 11 },
    memb1Post:  { x: 175, y: 278, size: 9, color: verde, lineHeight: 11 },
    memb2Pre:   { x: 615, y: 210, size: 9, color: azul,  lineHeight: 11 },
    memb2Post:  { x: 300, y: 280, size: 9, color: verde, lineHeight: 11 },

    entrada:    { x: 545, y: 258, size: 9, color: negro, lineHeight: 11 },
    salida:     { x: 700, y: 232, size: 9, color: verde, lineHeight: 11 },
