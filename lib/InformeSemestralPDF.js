...
export async function generarPdfSemestralBlob(datos) {
  ...
  const c = {
    ...
    memb1Pre:   { x: 230, y: 205, size: 10, color: azul,  lineHeight: 11 },
    memb1Post:  { x: 160, y: 277, size: 10, color: verde, lineHeight: 11 },
    memb2Pre:   { x: 398, y: 202, size: 10, color: azul,  lineHeight: 11 },
    memb2Post:  { x: 285, y: 274, size: 10, color: verde, lineHeight: 11 },
