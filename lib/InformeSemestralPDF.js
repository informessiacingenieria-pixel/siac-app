...
export async function generarPdfSemestralBlob(datos) {
  ...
  const c = {
    ...
    parrafoIntro:   { x: 38, y: 142, size: 11, color: negro, lineHeight: 14, ancho: 770 },
    ...
    parrafoConcl:   { x: 38, y: 385, size: 11, color: negro, lineHeight: 14, ancho: 770 },

    xFirma: 377, yFirma: 490,
    xNombreCentro: 415, yNombre: 485,
  }
