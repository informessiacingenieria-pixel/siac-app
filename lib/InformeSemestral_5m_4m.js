...
export async function generarPdfSemestral5m4mBlob(datos) {
  const {
    cliente,
  ...
  const plantillaUrl = '/plantillas/Plantilla_informe_matencion_5m_4s_2o.pdf'
  ...
  const c1 = {
    ...
    m1Pre:  { x: 166, y: 215 }, m1Post: { x: 166, y: 277 },
    m2Pre:  { x: 295, y: 216 }, m2Post: { x: 282, y: 277 },
    m3Pre:  { x: 158, y: 319 }, m3Post: { x: 148, y: 375 },
    m4Pre:  { x: 289, y: 319 }, m4Post: { x: 286, y: 375 },
    m5Pre:  { x: 460, y: 252 }, m5Post: { x: 452, y: 318 },
    entrada:{ x: 574, y: 285 }, salida: { x: 697, y: 265 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 134, y: 149 }, m1Post: { x: 134, y: 214 },
    m2Pre:  { x: 254, y: 148 }, m2Post: { x: 256, y: 214 },
    m3Pre:  { x: 370, y: 149 }, m3Post: { x: 370, y: 214 },
    m4Pre:  { x: 480, y: 148 }, m4Post: { x: 481, y: 214 },
    entrada:{ x: 587, y: 185 }, salida: { x: 700, y: 170 },
  ...
  // Firma solo en página 2
  const firmaUrl = FIRMAS['Baldomero Urriola']
  if (firmaUrl) {
    try {
  ...
  centradoEn(pag2, 'Baldomero Urriola', c2.xNombre, c2.yNombre, 11, negro)
