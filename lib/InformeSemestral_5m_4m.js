...
export async function generarPdfSemestral5m4mBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 180, y: 215 }, m1Post: { x: 181, y: 275 },
    m2Pre:  { x: 300, y: 217 }, m2Post: { x: 285, y: 275 },
    m3Pre:  { x: 180, y: 319 }, m3Post: { x: 177, y: 375 },
    m4Pre:  { x: 300, y: 319 }, m4Post: { x: 290, y: 375 },
    m5Pre:  { x: 460, y: 260 }, m5Post: { x: 450, y: 320 },
    entrada:{ x: 574, y: 300 }, salida: { x: 697, y: 280 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 150, y: 148 }, m1Post: { x: 150, y: 214 },
    m2Pre:  { x: 300, y: 148 }, m2Post: { x: 300, y: 214 },
    m3Pre:  { x: 400, y: 148 }, m3Post: { x: 400, y: 214 },
    m4Pre:  { x: 510, y: 148 }, m4Post: { x: 510, y: 214 },
    entrada:{ x: 587, y: 200 }, salida: { x: 690, y: 190 },
