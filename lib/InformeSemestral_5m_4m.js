...
export async function generarPdfSemestral5m4mBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 168, y: 215 }, m1Post: { x: 169, y: 277 },
    m2Pre:  { x: 297, y: 216 }, m2Post: { x: 284, y: 277 },
    m3Pre:  { x: 160, y: 319 }, m3Post: { x: 150, y: 375 },
    m4Pre:  { x: 289, y: 319 }, m4Post: { x: 288, y: 375 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 136, y: 149 }, m1Post: { x: 136, y: 214 },
    m2Pre:  { x: 256, y: 148 }, m2Post: { x: 258, y: 214 },
    m3Pre:  { x: 372, y: 149 }, m3Post: { x: 372, y: 214 },
    m4Pre:  { x: 482, y: 148 }, m4Post: { x: 483, y: 214 },
