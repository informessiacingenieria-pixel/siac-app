...
export async function generarPdfSemestral5m4mBlob(datos) {
  ...
  const c1 = {
    ...
    m1Pre:  { x: 172, y: 215 }, m1Post: { x: 171, y: 277 },
    m2Pre:  { x: 298, y: 216 }, m2Post: { x: 284, y: 277 },
    m3Pre:  { x: 168, y: 319 }, m3Post: { x: 163, y: 375 },
    m4Pre:  { x: 290, y: 319 }, m4Post: { x: 288, y: 375 },
    m5Pre:  { x: 460, y: 255 }, m5Post: { x: 452, y: 318 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 140, y: 148 }, m1Post: { x: 140, y: 214 },
    m2Pre:  { x: 270, y: 148 }, m2Post: { x: 270, y: 214 },
    m3Pre:  { x: 380, y: 149 }, m3Post: { x: 380, y: 214 },
    m4Pre:  { x: 490, y: 148 }, m4Post: { x: 490, y: 214 },
