...
export async function generarPdfSemestral6t4s2oBlob(datos) {
  const {
    cliente,
  ...
  const plantillaUrl = '/plantillas/Plantilla_informe_matencion_6t_4s_2o.pdf'
  ...
  const c1 = {
    ...
    m1Pre:  { x: 229, y: 220 }, m1Post: { x: 241, y: 286 },
    m2Pre:  { x: 367, y: 219 }, m2Post: { x: 357, y: 282 },
    // Membranas 3, 4, 5, 6 en paralelo (fila derecha)
    m3Pre:  { x: 229, y: 320 }, m3Post: { x: 230, y: 381 },
    m4Pre:  { x: 366, y: 321 }, m4Post: { x: 360, y: 379 },
    m5Pre:  { x: 543, y: 256 }, m5Post: { x: 540, y: 321 },
    m6Pre:  { x: 678, y: 256 }, m6Post: { x: 674, y: 321 },
    entrada:{ x: 520, y: 402 }, salida: { x: 657, y: 389 },
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 153, y: 164 }, m1Post: { x: 143, y: 229 },
    m2Pre:  { x: 264, y: 164 }, m2Post: { x: 257, y: 229 },
    m3Pre:  { x: 372, y: 164 }, m3Post: { x: 367, y: 229 },
    m4Pre:  { x: 480, y: 164 }, m4Post: { x: 477, y: 229 },
    entrada:{ x: 587, y: 162 }, salida: { x: 700, y: 147 },
