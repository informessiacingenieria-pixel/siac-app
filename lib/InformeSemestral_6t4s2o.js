...
export async function generarPdfSemestral6t4s2oBlob(datos) {
  ...
  const c2 = {
    cliente:  { x: 680, y: 73 },
    m1Pre:  { x: 153, y: 164 }, m1Post: { x: 143, y: 232 },
    m2Pre:  { x: 264, y: 165 }, m2Post: { x: 257, y: 230 },
    m3Pre:  { x: 372, y: 166 }, m3Post: { x: 367, y: 232 },
    m4Pre:  { x: 480, y: 162 }, m4Post: { x: 477, y: 232 },
    entrada:{ x: 588, y: 108 }, salida: { x: 700, y: 147 },
