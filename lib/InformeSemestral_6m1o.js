...
export async function generarPdfSemestral6s1oBlob(datos) {
  ...
  const c2 = {
    cliente:      { x: 40, y: 80 }, // Esquina superior izq página 2
    parrafoConcl: { x: 18, y: 150, size: 11, color: negro, lineHeight: 14, ancho: 790 },
    xFirma: 400,   // Coordenada X de la firma
    yFirma: 450,   // Coordenada Y de la firma
    xNombre: 420,  // Coordenada X del nombre
    yNombre: 380,  // Coordenada Y del nombre
  }
