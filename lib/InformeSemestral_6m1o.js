...
export async function generarPdfSemestral6s1oBlob(datos) {
  ...
  const c1 = {
    ...
    m3Pre:  { x: 224, y: 318 }, m3Post: { x: 253, y: 383 },
    m4Pre:  { x: 366, y: 321 }, m4Post: { x: 360, y: 392 },
    m5Pre:  { x: 543, y: 256 }, m5Post: { x: 540, y: 321 },
    m6Pre:  { x: 678, y: 256 }, m6Post: { x: 678, y: 321 },
    entrada:{ x: 475, y: 447 }, salida: { x: 613, y: 428 },
  }
  ...
  const c2 = {
    ...
    xFirma: 370,   // Coordenada X de la firma
    yFirma: 290,   // Coordenada Y de la firma
    xNombre: 420,  // Coordenada X del nombre
    yNombre: 397,  // Coordenada Y del nombre
  }
